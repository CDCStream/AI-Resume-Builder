        ...
        <div className="mb-6" data-section="contact">
          ...
          <div className="space-y-2 text-sm text-blue-100">
            ...
            {basics?.profiles?.find(p => p.network === "LinkedIn")?.url && (
              <p className="text-blue-300 flex items-center gap-2 break-all">
            ...
            {basics?.profiles?.find(p => p.network === "GitHub")?.url && (
              <p className="text-blue-100 flex items-center gap-2 break-all">

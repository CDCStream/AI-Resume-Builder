      ...
      <article className="max-w-3xl mx-auto px-4 -mt-32 relative z-10">
        ...
        <div className="border-t border-gray-200 pt-8 pb-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
            ...
            <Link href="/salary/data-analyst" className="bg-gray-50 rounded-lg px-4 py-3 text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-colors text-center font-medium">
              Data Analyst Salary →
            </Link>
            <Link href="/salary/project-manager" className="bg-gray-50 rounded-lg px-4 py-3 text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-colors text-center font-medium">
